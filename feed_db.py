...
if 'port' not in os.environ:
    os.environ['port'] = '5432'  # Set default port to 5432 if not present
#--------------------Database Configuration--------------------
DB_CONFIG = {
    "host": os.getenv("host"),
    "port": int(os.environ["port"]),#5432 port is default for postgres, we can change it to 3306 for mysql or 1433 for sql server
